...
export const linkClass = "text-purple-600 hover:text-purple-800 transition-colors";
...
export const submitBtn =
  "block m-auto bg-purple-600 text-white font-semibold py-3 px-3 rounded-3xl hover:bg-purple-800 transition-colors cursor-pointer mt-2 text-sm tracking-tight";

// ─── Navbar ───────────────────────────────────────────
export const navbarClass =
  "bg-gray-100 backdrop-blur-xl backdrop-saturate-150 border-b border-[#e8e8ed] px-8 py-8 h-[52px] flex items-center sticky top-0 z-50";
export const navContainerClass = "max-w-5xl mx-auto w-full flex items-center justify-between ";
export const navBrandClass = "text-2xl text-purple-900 font-semibold text-[#1d1d1f] tracking-tight";
export const navLinksClass = "flex items-center gap-7";
export const navLinkClass = "text-2xl text-gray-500 hover:text-[#1d1d1f] transition-colors font-normal";
export const navLinkActiveClass = "text-2xl text-purple-800 font-medium";
